 ...
 */
final class Version20240820235406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE anexo (id INT NOT NULL, observacao_id INT NOT NULL, nome VARCHAR(255) NOT NULL, extensao VARCHAR(255) NOT NULL, tamanho VARCHAR(255) NOT NULL, url VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_CD7EAF2CFB4CACD3 ON anexo (observacao_id)');
        ...
        $this->addSql('ALTER TABLE anexo ADD CONSTRAINT FK_CD7EAF2CFB4CACD3 FOREIGN KEY (observacao_id) REFERENCES observacao (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE anexo DROP CONSTRAINT FK_CD7EAF2CFB4CACD3');
